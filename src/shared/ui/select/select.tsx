  ...
  return (
    <div className={'flex flex-col gap-1'}>
      ...
      <Listbox value={value} {...rest}>
        <div
          className={
            'relative rounded border border-slate-300 focus-within:border-teal-600 h-10 outline-none data-[headlessui-state="open"]:z-10 dark:border-slate-700 dark:hover:border-slate-500'
          }
        >
          <Listbox.Button
